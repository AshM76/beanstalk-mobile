...
class OnboardingInformationPage extends StatefulWidget {
  @override
  _OnboardingInformationPageState createState() => _OnboardingInformationPageState();
}

class _OnboardingInformationPageState extends State<OnboardingInformationPage> {
