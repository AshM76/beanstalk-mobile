...
class OnboardingConditionPage extends StatefulWidget {
  @override
  _OnboardingConditionPageState createState() => _OnboardingConditionPageState();
}

class _OnboardingConditionPageState extends State<OnboardingConditionPage> {
  ...
  _onboarding(BuildContext context) async {
