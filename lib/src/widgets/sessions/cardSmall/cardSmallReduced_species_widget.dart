...
Widget speciesCardSmallReduced(Size size, StrainType specie, bool isActive) {
  return Column(
    children: [
      Container(
        padding: EdgeInsets.only(top: size.height * 0.006, bottom: size.height * 0.003),
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              specie.icon!,
                              style: TextStyle(
                                  color: Colors.white, fontSize: AppFontSizes.contentSize, fontFamily: "Poppins", fontWeight: FontWeight.w600),
                            ),
                          )),
                        ],
                      ),
